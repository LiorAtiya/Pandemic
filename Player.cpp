...
namespace pandemic {
    ...
    Player& Player::discover_cure(Color c){
        ...
        //         if(!board_game.get_details_of_cities()[current_place].discover_cure){
        ...
        //                 }
        //             }
        //             //discover_cure for all city with the same color
        //             for(auto &pair : board_game.get_details_of_cities()){
        //                 if(pair.second.color == c){
        //                     pair.second.discover_cure = true;
        //                 }
        //             }
    ...
    Player& Player::treat(City c){
        // // cout << boolalpha;
        // // cout << board_game.get_details_of_cities()[this->current_place].discover_cure;
        // //If there is a disease in the current city
        // cout <<"disease level: " << board_game.get_details_of_cities()[c].disease_level << endl;
        // if(board_game.get_details_of_cities()[this->current_place].disease_level > 0){
        //     //If there was a "discover_cure" in the current city
        //     if(board_game.get_details_of_cities()[this->current_place].discover_cure){
    ...
    Player& Player::take_card(City c){
        ...
        // // cout << my_cards[board_game.get_details_of_cities()[c].color].size() << endl;
        return *this;
    }
