...
TEST_CASE("Player - method: build()"){
	...
	Board board_game2;
	Dispatcher player2 {board_game2, all_citis[0]};
	Board board_game3;
	Scientist player3 {board_game3, all_citis[0],4};
	// Researcher player4 {Board(), all_citis[0]};
	// Medic player5 {Board(), all_citis[0]};
	// Virologist player6 {Board(), all_citis[0]};
	// GeneSplicer player7 {Board(), all_citis[0]};
	// FieldDoctor player8 {Board(), all_citis[0]};
